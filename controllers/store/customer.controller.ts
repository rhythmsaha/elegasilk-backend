...
export const createCustomer = asyncHandler(
    async (req: Request, res: Response, next: NextFunction) => {
        ...
        try {
            ...
            if (customerExists && !customerExists.verified)
                return resendVerificationLink(req, res, next);
 ...
 */
export const resendVerificationLink = asyncHandler(
    async (req: Request, res: Response, next: NextFunction) => {
 ...
 */
export const verifyCustomerAccount = asyncHandler(
    async (req: Request, res: Response, next: NextFunction) => {
 ...
 */
export const refreshCustomerSession = asyncHandler(
    async (req: Request, res: Response, next: NextFunction) => {
...
export const createCustomerByAdmin = asyncHandler(
    async (req: Request, res: Response, next: NextFunction) => {
        const { firstName, lastName, email, password, phone } = req.body as ICustomer & {
            password: string;
        };
...
export const updateCustomerProfileByAdmin = asyncHandler(
    async (req: Request, res: Response, next: NextFunction) => {}
);

export const deleteCustomerAccountByAdmin = asyncHandler(
    async (req: Request, res: Response, next: NextFunction) => {}
);

export const getCustomerProfileByAdmin = asyncHandler(
    async (req: Request, res: Response, next: NextFunction) => {}
);

export const getCustomersListByAdmin = asyncHandler(
    async (req: Request, res: Response, next: NextFunction) => {}
);
